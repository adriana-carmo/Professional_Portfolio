        ...
        <div className="col-lg-3"> 
          <div className="card_profile">
            ...
            <div>
              ...
              <span>Technology: Html / CSS / Node.js / MongoDB </span>
            </div>
          </div>
        </div>
        <div className="col-lg-3"> 
          <div className="card_profile">
            ...
            <div>
              ...
              <span>Technology: Html / CSS / Node.js / Indexed Database / PWA / Service-Worker / MongoDB </span>
            </div>
          </div>
        </div>
        <div className="col-lg-3">
          <div className="card_profile">
            ...
            <div>
              ...
              <span>Technology: Html / CSS / React </span>
            </div>
          </div>
        </div>
        <div className="col-lg-1"></div>
        ...
        <div className="col-lg-3"> 
          <div className="card_profile">
            ...
            <div>
              ...
              <span>Technology: Html / CSS / Node.js / Ajax / Routes </span>
            </div>
          </div>
        </div>
        <div className="col-lg-3"> 
          <div className="card_profile">
            ...
            <div>
              ...
              <span>Technology: Html / CSS / Node.js / Ajax / MVC framework / MySQL </span>
            </div>
          </div>
        </div>
        <div className="col-lg-3">
